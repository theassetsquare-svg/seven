...
- main 브랜치 → Cloudflare Pages 자동 배포 → `https://seven-97b.pages.dev/`

### 2) 메인 페이지 SEO 풀세팅 (`index.html`)
- `<html lang="ko">` 한국어 명시
- 타이틀 (45자): `대전세븐나이트 영탁 | 4인1조 W.T 010-7770-0869 테이블예약·부킹`
...
- 좌: 대전세븐나이트 / 웨이터 영탁 / TEL 010-7770-0869
- 우: W.T·영탁·4인1조 원형 골드/레드 스탬프
...
```html
<meta name="naver-site-verification" content="b16c3b3f5bfa7fa87c4b8c49060c538641b5428d" />
```
라이브 노출 확인 완료.
...
- 키 파일: `/63ddda7bd582472cbcdcd585babf59de.txt` (라이브, 키-파일명 일치)
...
### 라이브 HTML 핵심 메타
- ✅ Naver 검증코드: `b16c3b3f5bfa7fa87c4b8c49060c538641b5428d`
- ✅ Google 검증코드: `HJjm7MRxykCQ7d_9L7glaTeeaWrmJIzAKY0BcNcfm88`
...
| 3 | Google: site:seven-97b.pages.dev | ✅ | 사이트 인지됨 |
| 4 | Naver: 대전세븐나이트 | ❌ | 인덱스 전 |
| 5 | Naver: 대전세븐나이트 영탁 | ❌ | 인덱스 전 |
| 6 | Naver: site:seven-97b.pages.dev | ✅ | 사이트 인지됨 |
| 7 | Bing: 대전세븐나이트 | ❌ | 인덱스 전 |
| 8 | Bing: site:seven-97b.pages.dev | ✅ (6회) | 부분 인덱싱 진행 |
...
3. 좌측 **요청 > 웹페이지 수집** → `https://seven-97b.pages.dev/` → 수집 요청
...
### D. 고유 도메인 (선택, 강력 추천)
- `seven-97b.pages.dev` 임시 주소 → 검색 점수 페널티 있음
- 가비아/카페24에서 1~2만원/년
...
| D+7~14 | 네이버 인덱싱 본격화, "대전세븐나이트 영탁" 1~3위 가능 |
...
- **Naver 검증코드**: `b16c3b3f5bfa7fa87c4b8c49060c538641b5428d`
- **Google 검증코드**: `HJjm7MRxykCQ7d_9L7glaTeeaWrmJIzAKY0BcNcfm88`
- **IndexNow 키**: `63ddda7bd582472cbcdcd585babf59de`
